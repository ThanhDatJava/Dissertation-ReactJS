...
class DoctorExtraInfor extends Component {
  ...
  render() {
    ...
    return (
      <div className="doctor-extra-infor-container mt-3">
        ...
        <div className="content-down">
          {isShowDetailInfor === false && (
            <div className="short-infor">
              <FormattedMessage id="patient.extra-infor-doctor.examination-prices" />
              {extraInfor &&
            ...
            <>
              ...
              <div className="hide-price">
                <span onClick={() => this.showHideDetailInfor(false)}>
                  <FormattedMessage id="patient.extra-infor-doctor.collapse" />
                </span>
              </div>
            </>
          )}
